...
OUT_DIR = PROJECT_ROOT / "data/literature-bank-medical"
REPORT = PROJECT_ROOT / "reports/literature_bank_medical.md"

QUERIES: dict[str, list[str]] = {
    "diagnostic_sample_size": [
        "sample size determination sensitivity specificity diagnostic accuracy study",
        "confidence interval sensitivity specificity binomial proportion diagnostic",
        "Bayesian sample size diagnostic accuracy prior information",
        "precision based sample size estimation diagnostic test evaluation",
    ],
    "prevalence_ppv": [
        "positive predictive value prevalence dependence diagnostic test",
        "predictive values spectrum bias prevalence screening population",
        "number needed to screen yield low prevalence screening programme",
        "Bayes theorem post test probability likelihood ratio diagnosis",
    ],
    "reporting_standards": [
        "STARD statement reporting diagnostic accuracy studies checklist",
        "TRIPOD reporting prediction model development validation",
        "QUADAS risk of bias assessment diagnostic accuracy",
        "reporting guidelines machine learning clinical prediction model",
    ],
    "screening_programme_design": [
        "screening programme design false positive burden low prevalence",
        "two stage screening triage test confirmatory test sequence",
        "verification bias partial verification diagnostic accuracy",
        "cost effectiveness screening threshold selection yield",
    ],
}
