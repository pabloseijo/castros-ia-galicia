...
OUT_DIR = PROJECT_ROOT / "data/literature-bank-architecture"
REPORT = PROJECT_ROOT / "reports/literature_bank_architecture.md"

QUERIES: dict[str, list[str]] = {
    "arch_comparison": [
        "comparison CNN vision transformer archaeological detection LiDAR benchmark",
        "UNet vs transformer semantic segmentation remote sensing comparison",
        "ConvNeXt Swin ViT benchmark aerial imagery small object detection",
        "architecture ablation deep learning archaeological prospection",
    ],
    "two_stage_vs_end_to_end": [
        "two stage versus one stage object detection comparison small objects",
        "region proposal network faster rcnn vs yolo aerial imagery",
        "cascade rcnn detection quality iou threshold",
        "end to end training versus preprocessing pipeline detection",
    ],
    "input_representation": [
        "LiDAR visualisation choice hillshade sky view factor local relief CNN input",
        "multi scale relief model input deep learning archaeology",
        "digital terrain model derivative selection neural network detection",
        "multi channel fusion elevation orthophoto segmentation archaeology",
    ],
    "small_data_arch": [
        "architecture choice small training set overfitting remote sensing segmentation",
        "model capacity limited labels transfer learning aerial detection",
        "attention mechanism small object detection remote sensing",
    ],
}
