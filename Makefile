...
weak-label-msrm-features:
	$(GEO_PYTHON) scripts/evaluate_weak_label_msrm_features.py --dataset-name full

weak-label-spatial-cv:
	$(GEO_PYTHON) scripts/evaluate_weak_label_spatial_cv.py --folds 5

weak-label-rgb-relief-msrm-baseline-full:
	$(GEO_PYTHON) scripts/train_weak_label_rgb_relief_baseline.py --rgb-features data/weak-label-baseline-v1/weak_label_rgb_baseline_full_features.tsv --rgb-metrics data/weak-label-baseline-v1/weak_label_rgb_baseline_full_metrics.tsv --relief-features data/weak-label-relief-v1/weak_label_relief_features_train.tsv --relief-features data/weak-label-relief-v1/weak_label_relief_features_val.tsv --relief-features data/weak-label-relief-v1/weak_label_relief_features_test.tsv --relief-features data/weak-label-relief-v1/weak_label_relief_features_holdouts.tsv --relief-metrics data/weak-label-relief-v1/weak_label_relief_metrics_train.tsv --relief-metrics data/weak-label-relief-v1/weak_label_relief_metrics_val.tsv --relief-metrics data/weak-label-relief-v1/weak_label_relief_metrics_test.tsv --relief-metrics data/weak-label-relief-v1/weak_label_relief_metrics_holdouts.tsv --msrm-features data/weak-label-msrm-v1/weak_label_msrm_features_full.tsv --train-dataset train --artifact-prefix weak_label_rgb_relief_msrm_full --report reports/weak_label_rgb_relief_msrm_baseline_full_v1.md

weak-label-priority-blend-msrm-full:
	$(GEO_PYTHON) scripts/evaluate_weak_label_priority_blend.py --features data/weak-label-fusion-v1/weak_label_rgb_relief_msrm_full_features.tsv --scores data/weak-label-fusion-v1/weak_label_rgb_relief_msrm_full_scores.tsv --fusion-metrics data/weak-label-fusion-v1/weak_label_rgb_relief_msrm_full_metrics.tsv --artifact-prefix weak_label_priority_blend_msrm_full --report reports/weak_label_priority_blend_msrm_full_v1.md

weak-label-castro-mamoa-specialist-msrm-full:
	$(GEO_PYTHON) scripts/train_weak_label_castro_mamoa_specialist.py --features data/weak-label-fusion-v1/weak_label_rgb_relief_msrm_full_features.tsv --fusion-scores data/weak-label-fusion-v1/weak_label_rgb_relief_msrm_full_scores.tsv --priority-scores data/weak-label-fusion-v1/weak_label_priority_blend_msrm_full_scores.tsv --train-dataset train --artifact-prefix weak_label_castro_mamoa_specialist_msrm_full --report reports/weak_label_castro_mamoa_specialist_msrm_full_v1.md

weak-label-error-review-msrm-full:
	$(GEO_PYTHON) scripts/build_weak_label_error_review_queue.py --fusion-scores data/weak-label-fusion-v1/weak_label_rgb_relief_msrm_full_scores.tsv --priority-scores data/weak-label-fusion-v1/weak_label_priority_blend_msrm_full_scores.tsv --specialist-scores data/weak-label-fusion-v1/weak_label_castro_mamoa_specialist_msrm_full_scores.tsv --artifact-prefix weak_label_error_review_queue_msrm_full --report reports/weak_label_error_review_queue_msrm_full_v1.md

weak-label-trasancos-inference:
	$(GEO_PYTHON) scripts/build_trasancos_inference_ranking.py

# Same grid, but each cell searches for the centre where the ring response
# peaks instead of assuming the landform sits at the chip centre.
weak-label-trasancos-inference-centered:
	$(GEO_PYTHON) scripts/build_trasancos_inference_ranking.py --stage score --grid-manifest data/trasancos-inference-v1/trasancos_grid_manifest.tsv --center-search-m 192 --center-search-step-m 32 --out-dir data/trasancos-centered-v1 --report reports/trasancos_inference_centered_v1.md
