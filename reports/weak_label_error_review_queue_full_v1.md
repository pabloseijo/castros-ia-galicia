...
- Queue TSV: `data/weak-label-fusion-v1/weak_label_error_review_queue_full.tsv`
- Queue GeoJSON: `data/weak-label-fusion-v1/weak_label_error_review_queue_full.geojson`

## Queue Counts

- `holdout_low_rank_positives`: 25
- `holdout_morphology_rescues`: 17
...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| `holdout_morphology_rescues` | `morphology_rescue_review` | 16 | 13 | 27 | 19 | 3 | 1 | `O Castro (Castro de Quintá)` | Known positive moved upward by max_safety; inspect morphology archetype missed by the main model. |
| `holdout_low_rank_positives` | `morphology_rescue_review` | 201 | 55 | 156 | 176 | 146 | 1 | `Castro de Pena Lopesa` | Known positive ranked low by the main fusion model; inspect as false-negative morphology. |
| `holdout_morphology_rescues` | `morphology_rescue_review` | 201 | 55 | 156 | 176 | 146 | 1 | `Castro de Pena Lopesa` | Known positive moved upward by max_safety; inspect morphology archetype missed by the main model. |
